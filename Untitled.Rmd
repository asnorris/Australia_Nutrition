...
fit <- stan_glm(D3 ~ treat + Mode_adj, data = new)
print(fit)

tab_model(fit, show.se = FALSE, show.ci = 0.95, show.r2 = TRUE, show.p = TRUE, bpe = "median", collapse.se = FALSE, title = "Support for Menu Change Over Ban", dv.labels = "Support for Menu Change: 1-5 with 5 signaling strong support", pred.labels = c("(Intercept)","Transparency Message", "Mode of Survey"))
```
